...
public interface IAssetWorkflowCoordinator {
    ...
    DeletedPathsSyncResult SyncDeletedPaths(IEnumerable<string>? deletedPaths, params IEnumerable<BaseResource>[] resourceCollections);
    ...
    ServerStatusSyncResult SyncStatusesWithServer(HashSet<string>? serverPaths, params IEnumerable<BaseResource>[] resourceCollections);
