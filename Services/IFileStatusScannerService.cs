...
public interface IFileStatusScannerService {
    ...
    /// <summary>
    /// Сканирует все ассеты (текстуры и модели).
    /// </summary>
    ...
    ScanResult ScanAll(IEnumerable<TextureResource> textures, IEnumerable<ModelResource> models);
    ...
    int ProcessDeletedPaths(IEnumerable<string> deletedPaths, IEnumerable<TextureResource> textures, IEnumerable<ModelResource> models);
