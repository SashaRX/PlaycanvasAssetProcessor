...
public sealed class D3D11TextureRenderer : IDisposable {
    ...
    private struct ShaderConstants {
        ...
        public uint TilingEnabled; // 0 = clamp, 1 = wrap/tiles
    ...
    private void CreateSamplers() {
        ...
        // Point sampling (wrap)
        var pointWrapDesc = new SamplerDescription {
            Filter = Filter.MinMagMipPoint,
        ...
        // Linear sampling (wrap)
        var linearWrapDesc = new SamplerDescription {
            Filter = Filter.MinMagMipLinear,
            AddressU = TextureAddressMode.Wrap,
            AddressV = TextureAddressMode.Wrap,
            AddressW = TextureAddressMode.Wrap,
    ...
    public void LoadTexture(TextureData textureData) {
        ...
        try {
            ...
            logger.Error(ex, "Failed to create D3D11 texture");
            throw;
        } finally {
            // Free pinned handles
            ...
            // Reset mip level (preserve zoom/pan when switching textures)
            currentMipLevel = 0;
        } // lock (renderLock)
    }
    ...
    private void UpdateConstantBuffer() {
        ...
        var constants = new ShaderConstants {
            ...
            TilingEnabled = tilingEnabled ? 1u : 0u,
            Padding3 = 0u,
            Padding4 = 0u
        };
